...
```{r}
DEnv <- DEnvelope(X, r = seq(0, 30000), NumberOfSimulations = 100, Alpha = 0.05, 
          Cases = "INDUSTRY", Controls = "BENCH", Intertype = TRUE, Global = FALSE,
          verbose = interactive())

autoplot(DEnv, main = "", ylim = c(0, 200))
